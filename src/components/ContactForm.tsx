      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <motion.div custom={0} variants={fieldVariants} initial="hidden" animate="visible">
            <label className="block text-sm font-semibold text-[#241612] mb-2">
              Name *
            </label>
            <input
              type="text"
              ...
              disabled={isLoading}
              className={cn(
                "w-full rounded-lg border bg-white px-4 py-3 text-sm font-body text-[#241612] outline-none transition-all",
                errors.name
                  ? "border-red-500 focus:ring-2 focus:ring-red-200"
                  : "border-[#efe2cf] focus:border-[#8B0000] focus:ring-2 focus:ring-[#8B0000]/10"
              )}
        ...
        <motion.div custom={4} variants={fieldVariants} initial="hidden" animate="visible">
          ...
          <textarea
            ...
            rows={5}
            className={cn(
              "w-full rounded-lg border bg-white px-4 py-3 text-sm font-body text-[#241612] outline-none transition-all resize-none",
              errors.message
                ? "border-red-500 focus:ring-2 focus:ring-red-200"
                : "border-[#efe2cf] focus:border-[#8B0000] focus:ring-2 focus:ring-[#8B0000]/10"
            )}
