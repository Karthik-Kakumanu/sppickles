...
const aboutCopy = {
  ...
  te: {
    ...
    operationsBody:
      "తయారీ, ప్యాకింగ్, నేరుగా సపోర్ట్, భారత్ డెలివరీ, USA విచారణలు, విదేశీ ఆర్డర్లు అన్నీ ఇప్పుడు మరింత సమగ్రంగా వెబ్‌సైట్‌లో చూపబడతాయి. దీంతో ఇంటి ఆర్డర్లకే కాదు, పెద్ద కుటుంబ లేదా గిఫ్టింగ్ ఆర్డర్లకూ బ్రాండ్ సిద్ధంగా ఉందని తెలుస్తుంది.",
