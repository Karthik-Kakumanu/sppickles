...
const contactCopy = {
  ...
  te: {
    ...
    title: "లొకేషన్, ఫోన్ నంబర్లు, వాట్సాప్, విచారణ ఫారం, డెలివరీ వివరాలు అన్నీ ఒకే చోట",
    intro:
    ...
    contactLead:
      "వాట్సాప్, ఫోన్, ఈమెయిల్ లేదా కింది విచారణ ఫారం ద్వారా కస్టమర్ నేరుగా టీమ్‌ను సంప్రదించవచ్చు.",
    coverageTitle: "డెలివరీ సపోర్ట్",
    coveragePoints: [
      "భారతదేశం అంతటా శ్రద్ధగా ప్యాక్ చేసి పంపే సపోర్ట్.",
      "USA విచారణలు మరియు విదేశీ షిప్పింగ్ ప్రత్యక్ష నిర్ధారణ తర్వాత నిర్వహిస్తాము.",
      "బల్క్ ఆర్డర్లు, గిఫ్టింగ్ ఆర్డర్లు, మళ్లీ చేసే కుటుంబ ఆర్డర్లకు ప్రత్యేక సమన్వయం ఉంటుంది.",
    ],
    formTitle: "త్వరిత విచారణ పంపండి",
    formLead:
    ...
    placeholders: {
      ...
      topic: "ఉదాహరణ: బల్క్ ఆర్డర్, USA విచారణ, ప్రత్యేక ప్యాక్",
...
const ContactPage = () => {
  ...
  const whatsappLink = useMemo(() => {
    const lines = [
      language === "te" ? "నమస్కారం, నాకు ఒక విచారణ ఉంది." : "Hello, I have an enquiry.",
