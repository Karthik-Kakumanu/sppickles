...
const homeCopy = {
  ...
  te: {
    ...
    heroTitle: "శుద్ధ శాకాహార బ్రాహ్మణ శైలిలో పచ్చళ్ళు, పొడులు, వడియాలు",
    heroDescription:
      "సంప్రదాయ పికిల్స్‌లో శుద్ధ శాకాహార బ్రాహ్మణ శైలిలో తయారయ్యే పచ్చళ్ళు, పొడులు, వడియాలు మీ రోజువారీ భోజనానికి ఇంటివంట రుచి, నమ్మకం, తేలికైన అనుభూతిని ఇస్తాయి.",
    heroDetails: [
      ...
      "పొడులు మరియు వడియాలు: రోజువారీ భోజనానికి వెంటనే రుచి, కరకరలాడే తోడు, బ్రాహ్మణ ఇంటివంట అనుభూతిని అందించే సంప్రదాయ పదార్థాలు.",
    ],
    heroMetrics: [
    ...
    categoryTitle: "ఉప్పు పచ్చళ్ళు, తాలింపు పచ్చళ్ళు, పొడులు, వడియాలు",
    categoryDescription:
    ...
    reachDescription:
      "షిప్పింగ్ ధరలు ఇక్కడ చూపించడం లేదు. దాని బదులు భారత్ అంతటా డెలివరీ అందుబాటులో ఉందని, USA మరియు విదేశీ ఆర్డర్లకు ముందస్తు నిర్ధారణ తర్వాత సహాయం చేస్తామని చెబుతాం.",
    reachPoints: [
      "భారతదేశం అంతటా సురక్షితమైన ప్యాకింగ్‌తో డెలివరీ సపోర్ట్.",
      "USA మరియు ఇతర విదేశీ ఆర్డర్లకు ముందస్తు నిర్ధారణ తర్వాత సహాయం.",
            ...
            <div className="overflow-hidden rounded-[2rem] border border-[#d8e5d8]/50 bg-white/70 p-4 shadow-[0_16px_56px_rgba(30,79,46,0.07)] backdrop-blur-xl">
              ...
              <div className="mt-4 rounded-[1.25rem] border border-[#d8e5d8]/40 bg-[#f8faf6] p-5">
                ...
                <ul className="mt-4 space-y-2.5">
                  {[
                    isTe ? "ఉప్పు పచ్చళ్ళు, తాలింపు పచ్చళ్ళు, పొడులు, వడియాలు అన్నీ శుద్ధ శాకాహార పద్ధతిలో" : "Salted pickles, tempered pickles, podulu, and fryums made the same way",
