  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-16">
      ...
      <div className="w-full max-w-xl rounded-[2rem] border border-[#3D7A52] bg-[#2E5C3E] px-8 py-12 text-center shadow-md ring-1 ring-[#3D7A52]">
        <span className="mx-auto inline-flex h-16 w-16 items-center justify-center rounded-full border border-[#3D7A52] bg-[#1A3A2A] text-theme-heading">
          <AlertCircle className="h-8 w-8" />
        </span>
        <p className="mt-6 text-sm font-semibold uppercase tracking-[0.26em] text-theme-heading">
          404 Error
        </p>
        <h1 className="mt-3 font-heading text-4xl font-semibold text-theme-contrast">
          Page not found
        </h1>
