...
const pickleNameTelugu: Record<string, string> = {
  ...
  "Mango Ginger Pickle": "మామిడి అల్లం పచ్చడి",
  "Mango Ginger Avakaya": "మామిడి అల్లం ఆవకాయ",
  "Tomato Pachadi": "టొమోటో పచ్చడి",
  "Munakkaya Tomato": "మునక్కాయ టమోటా",
  "Green Chilli Avakaya": "పచ్చిమిరప ఆవకాయ",
  "Mamidi Turumu Pachadi": "మామిడి తురుము పచ్చడి",
  "Mamidi Mukkala Pachadi": "మామిడి ముక్కల పచ్చడి",
