...
const pickleNameTelugu: Record<string, string> = {
  ...
  "Tomato Pickle": "టమాటో",
  "Velakkaya Pickle": "వెలగకాయ",
  "Chintakaya (Hing)": "చింతకాయ",
  "Usirikaya (Hing)": "ఉసిరికాయ",
  "Lemon (Hing)": "నిమ్మకాయ",
  "Dabbakaya (Hing)": "దబ్బకాయ",
  "Tomato (Hing)": "టమాటో",
  "Velakkaya (Hing)": "వెలగకాయ",
  ...
  "Nuvvula Avakaya": "నువ్వుల ఆవకాయ",
  "Panasa Avakaya": "పనసపొట్టు ఆవకాయ",
  "Fresh Avakaya": "పచ్చి ఆవకాయ",
  Dosavakaya: "దోసవకాయ",
  Magaya: "మాగాయ",
  "Velakkaya Special": "వెలగకాయ స్పెషల్",
  "Brinjal Nilva Pachadi": "వంకాయ నిల్వ పచ్చడి",
  "Ginger Pickle": "అల్లం పచ్చడి",
  "Mango Ginger Pickle": "మామిడి అల్లం",
  "Tomato Pachadi": "టమాటో పచ్చడి",
