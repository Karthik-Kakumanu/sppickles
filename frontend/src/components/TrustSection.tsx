...
const TrustSection = () => {
  return (
    <section className="relative overflow-hidden bg-[#1A3A2A] py-24 md:py-32 mandala-bg">
      {/* Decorative Elements */}
      ...
      <div className="relative container max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {trustItems.map((item, idx) => (
            ...
            >
              <div className="theme-card relative h-full overflow-hidden rounded-2xl border border-[#3D7A52] p-8 shadow-md transition-smooth-lg hover:shadow-xl">
                ...
                {/* Shine Effect */}
                <div className="absolute inset-0 translate-x-full bg-gradient-to-r from-transparent via-[#A3D9B1]/10 to-transparent transition-transform duration-700 group-hover:translate-x-0" />
