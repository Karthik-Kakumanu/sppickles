...
const SiteLayout = () => {
  ...
  const ui =
    language === "te"
      ? {
          call: "కాల్ చేయండి",
          toggleMenu: "మెనూను తెరవండి లేదా మూసివేయండి",
        }
      : {
          call: "Call",
      ...
      <header className="sticky top-0 z-50 border-b border-[#e8ede8] bg-white shadow-[0_8px_20px_rgba(30,79,46,0.08)]">
        <div className={`${pageWrap} py-2.5 md:py-3.5`}>
          <div className="flex items-center justify-between gap-3 md:gap-4">
            <Link to="/" className="group flex shrink-0 items-center gap-2.5 transition-transform duration-300 hover:scale-105">
              <img
                src={brand.logo}
                alt={brand.name}
            ...
            <div className="inline-flex items-center gap-1 rounded-full border border-[#d8e5d8] bg-white p-1 shadow-[0_10px_24px_rgba(30,79,46,0.08)]">
              <button
                ...
                className={`rounded-full px-3 py-1.5 text-xs font-semibold transition ${
                  language === "te" ? "bg-[#2f7a43] !text-white" : "text-theme-body hover:bg-[#edf5ee]"
                } font-telugu`}
              ...
              <button
                ...
                className={`rounded-full px-3 py-1.5 text-xs font-semibold transition ${
                  language === "en" ? "bg-[#2f7a43] !text-white" : "text-theme-body hover:bg-[#edf5ee]"
                }`}
