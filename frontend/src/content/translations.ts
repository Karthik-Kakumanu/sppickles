...
export const content = {
  en: {
    ...
    footer: {
      ...
      subscribe: "Subscribe",
      followUs: "Follow Us",
      copyright: "© 2024 Sapradayani Pickles. All rights reserved. Handcrafted with love in Vijayawada.",
  ...
  te: {
    ...
    footer: {
      ...
      copyright: "© 2024 సప్రదాయని పచ్చళ్ళు. అన్ని హక్కులు సংరక్షించబడ్డాయి. విజయవాడలో ప్రేమతో చేసిన హస్తకళ.",
